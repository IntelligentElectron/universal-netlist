...
| Altium Designer | `.SchDoc` | Altium schematic documents, discovered and assembled through `.PrjPcb` project files: sheets are joined through ports and sheet entries under the project's net identifier scope, and design variants (Not Fitted rows, alternate parts, and parameter overrides) are selectable |
